...
static const struct qpnp_vadc_map_pt adcmap_l8150_btm_threshold[] = {
	{-200,	1560},
	{-180,	1540},
	{-160,	1517},
	{-140,	1494},
...
int32_t qpnp_adc_scale_l8150_batt_therm(struct qpnp_vadc_chip *chip,
			int32_t adc_code,
			const struct qpnp_adc_properties *adc_properties,
			const struct qpnp_vadc_chan_properties *chan_properties,
			struct qpnp_vadc_result *adc_chan_result)
{
	...
	return qpnp_adc_map_temp_voltage(
			adcmap_l8150_btm_threshold,
			ARRAY_SIZE(adcmap_l8150_btm_threshold),
			bat_voltage,
			&adc_chan_result->physical);
}
EXPORT_SYMBOL(qpnp_adc_scale_l8150_batt_therm);
